...
// Button Menu System (List Message)
const sections = [
    {
        title: "📜 SELECT A MENU BELOW",
        rows: [
            { title: "📥 Download Menu", rowId: "menu_1", description: "Access download commands" },
            { title: "👥 Group Menu", rowId: "menu_2", description: "Group management features" },
            { title: "🎉 Fun Menu", rowId: "menu_3", description: "Entertainment commands" },
            { title: "👑 Owner Menu", rowId: "menu_4", description: "Owner-only tools" },
            { title: "🤖 AI Menu", rowId: "menu_5", description: "AI powered chat & tools" },
            { title: "🌸 Anime Menu", rowId: "menu_6", description: "Anime image & info" },
            { title: "🔄 Convert Menu", rowId: "menu_7", description: "Convert image/video/text" },
            { title: "🧩 Other Menu", rowId: "menu_8", description: "Extra utilities" },
            { title: "💬 Reaction Menu", rowId: "menu_9", description: "Emotional reactions" },
            { title: "🏠 Main Menu", rowId: "menu_10", description: "Bot info & status" },
            { title: "⚙️ Settings Menu", rowId: "menu_11", description: "Bot configuration options" },
            { title: "💰 M-Pesa Menu", rowId: "menu_12", description: "Money features" },
            { title: "🖼️ Logo Menu", rowId: "menu_13", description: "Logo maker list" },
            { title: "📖 Bible Menu", rowId: "menu_14", description: "Bible chapters" },
            { title: "💻 Code Menu", rowId: "menu_15", description: "Developer utilities" },
        ],
    },
];
...
const listMessage = {
    ...
    footer: `BLOOD XMD V1.0.0\n> ${config.DESCRIPTION}`,
    title: "🩸 BLOOD XMD MAIN MENU 🩸",
    buttonText: "OPEN MENU 📜",
    sections,
};

await conn.sendMessage(from, listMessage, { quoted: verifiedContact });
